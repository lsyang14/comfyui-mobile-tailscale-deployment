...
export class RedisJobQueue {
  constructor({ url = process.env.REDIS_URL || 'redis://127.0.0.1:6379', prefix = 'comfy:jobs', maxSize = 10 } = {}) { this.url = url; this.client = createClient({ url }); this.workerClient = createClient({ url }); this.prefix = prefix; this.maxSize = maxSize; this.workerRunning = false; }
